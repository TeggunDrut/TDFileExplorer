...
for (let j = 0; j < obj.height; j++) {
  for (let i = 0; i < obj.width; i++) {
    map.grid[j][i] = getTile(obj.grid[j * obj.width + i], map);
  }
}

function init() {
  SIZEX = width / map.grid[0].length;
  SIZEY = height / map.grid.length;
  player.width = SIZEX;
  player.height = SIZEY;

  machines.push(
    new OreCollector({
      x: map.grid[0].length / 2 - 1,
      y: map.grid.length / 2 - 1,
      name: "Coal Collector",
      interval: 10,
      speed: 2,
      max: 1,
  ...
  machines.push(
    new Conveyor({
      ...
      interval: 50,
      speed: 10,
      path: "sprites/conveyor/conveyor-ver.png",
      map: map,
      direction: "down",
    })
  );
  machines.push(
    new Conveyor({
      ...
      interval: 50,
      speed: 10,
      path: "sprites/conveyor/conveyor-bottomleft.png",
      map: map,
      direction: "right",
    })
  );
  machines.push(
    new Conveyor({
      ...
      interval: 50,
      speed: 10,
      path: "sprites/conveyor/conveyor-hor.png",
      map: map,
      direction: "right",
    })
  );
  ...
  machines.push(
    new Conveyor({
      x: map.grid[0].length / 2 + 2,
      y: map.grid.length / 2 + 1,
      name: "Conveyor",
      interval: 50,
      speed: 10,
      path: "sprites/conveyor/conveyor-topright.png",
      map: map,
      direction: "down",
    })
  );
  ...
  machines.push(
    new Conveyor({
      x: map.grid[0].length / 2 + 3,
      y: map.grid.length / 2 + 2,
      name: "Conveyor",
      interval: 50,
      speed: 10,
      path: "sprites/conveyor/conveyor-bottomright.png",
      map: map,
      direction: "up",
    })
  );
  ...
  // let conveyorTimer = new Timer(
  //   50,
  //   () => {
  //     for (let i = machines.length - 1; i >= 0; i--) {
  //       if (machines[i].name === "Conveyor") {
  //         machines[i].moveItem(1);
  //       }
  //     }
  //   },
  //   true
